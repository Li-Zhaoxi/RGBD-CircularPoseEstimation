...
# coding=utf-8
import time
from AUBOControler import libpyauboi5
import logging
...
def move_rotX(current_quat, rot_angle):
    ...
    rot_rad = Rotation.from_rotvec(rad * np.array([1, 0, 0]))
    ...
    try:
        ...
        if result != RobotErrorType.RobotError_SUCC:
            ...
            while True:
                ...
                next_quat = move_rotX(robot_pose_so3['ori'], 30)
    ...
    try:
        ...
        if result != RobotErrorType.RobotError_SUCC:
            ...
            while True:
                ...
                # 运动到起点
                joint_radian = (83.213684 / 180.0 * pi, -20.109660 / 180.0 * pi, -67.889615 / 180.0 * pi, 
                                -49.398489 / 180.0 * pi, -84.059548 / 180.0 * pi, 0.1 / 180.0 * pi)
                robot.move_joint(joint_radian, True)
