...
*/
    ...
    */
        CV_WRAP virtual void detect(cv::InputArray _image, cv::OutputArray _lines,
     ...
     */
        CV_WRAP virtual void drawSegments(cv::InputOutputArray _image, cv::InputArray lines) = 0;
     ...
     */
        CV_WRAP virtual int compareSegments(const cv::Size &size, cv::InputArray lines1, cv::InputArray lines2, cv::InputOutputArray _image = cv::noArray()) = 0;
 ...
 */
    CV_EXPORTS_W cv::Ptr<LineSegmentDetector> createLineSegmentDetector(
